    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden bg-white dark:bg-slate-950 px-6">
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center space-y-6 pt-10">
        ...
        <div className="space-y-4">
          ...
          >
            <span className="text-5xl md:text-7xl font-black tracking-tight text-slate-800 dark:text-white leading-none">THE NEW</span>
            ...
            <div className="relative h-[80px] md:h-[140px] flex items-center justify-center overflow-visible w-full">
              <AnimatePresence mode="wait">
                <motion.span
                  ...
                  className="gradient-text text-6xl md:text-9xl font-black drop-shadow-[0_15px_45px_rgba(59,130,246,0.3)] inline-block select-none py-1"
                >
            ...
            <span className="mt-4 text-slate-400 dark:text-slate-600 text-3xl md:text-5xl font-extrabold tracking-tighter">Model of Urban Planning</span>
          </motion.h1>
        ...
        >
          <Link href="/search" className="group relative px-12 py-6 bg-slate-950 dark:bg-primary text-white font-black rounded-[30px] overflow-hidden hover:scale-105 active:scale-95 transition-all shadow-[0_20px_50px_rgba(0,0,0,0.1)]">
            ...
            <span className="flex items-center gap-4 uppercase tracking-[0.2em] text-[12px]">
              Find Parking <Search className="w-5 h-5 pointer-events-none" />
            </span>
          </Link>
          
          <Link href="/owner/new" className="px-12 py-6 bg-white dark:bg-slate-900 text-slate-900 dark:text-white border-2 border-slate-100 dark:border-slate-800 font-black rounded-[30px] hover:border-emerald-500/50 hover:bg-emerald-500/5 hover:shadow-2xl active:scale-95 transition-all flex items-center gap-4 uppercase tracking-[0.2em] text-[12px] group">
